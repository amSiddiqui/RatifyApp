        ...
        return (
            <div className="flex" ref={containerRef}>
                {showPrevPage && <Center
                    ...
                    style={{ width: 50, height: pageDim.height, backgroundImage: 'linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(245,245,245, 1) 100%)'}}>
                ...
                {showNextPage && <Center
                    ...
                    style={{ width: 50, height: pageDim.height, backgroundImage: 'linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(245, 245, 245,1) 100%' }}>
